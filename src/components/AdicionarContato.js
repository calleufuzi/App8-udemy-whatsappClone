        ...
        if(!this.props.cadastro_resultado_inclusao){
            return (
                <View style={{flex: 1}} >
                    ...
                    <View style={{ flex: 1 }} >
                        <Button title="Adicionar" color="#115354" onPress={() => this.props.adicionaContato(this.props.adiciona_contato_email)} />
            ...
            return (
                <View>
                    <Text style={{fontSize: 20, textAlign:'center'}} >Cadastro realizado com sucesso!</Text>
                </View>
            )
        }
    }
...
const mapStateToProps = state => (
    {
        ...
        cadastro_resultado_txt_sucesso: state.AppReducer.cadastro_resultado_txt_sucesso,
